 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tt(t){return t&&t._delegate?t._delegate:t}class S{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Jn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Jn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ue="@firebase/app",Ue="0.10.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T=new Un("@firebase/app"),Yn="@firebase/app-compat",Xn="@firebase/analytics-compat",Qn="@firebase/analytics",Zn="@firebase/app-check-compat",er="@firebase/app-check",tr="@firebase/auth",nr="@firebase/auth-compat",rr="@firebase/database",sr="@firebase/database-compat",ir="@firebase/functions",ar="@firebase/functions-compat",or="@firebase/installations",cr="@firebase/installations-compat",lr="@firebase/messaging",ur="@firebase/messaging-compat",hr="@firebase/performance",dr="@firebase/performance-compat",fr="@firebase/remote-config",pr="@firebase/remote-config-compat",gr="@firebase/storage",mr="@firebase/storage-compat",br="@firebase/firestore",wr="@firebase/vertexai-preview",yr="@firebase/firestore-compat",_r="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F=new Map,vr=new Map,de=new Map;function $e(t,e){try{t.container.addComponent(e)}catch(n){T.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function O(t){const e=t.name;if(de.has(e))return T.debug(`There were multiple attempts to register component ${e}.`),!1;de.set(e,t);for(const n of F.values())$e(n,t);for(const n of vr.values())$e(n,t);return!0}function ge(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cr{constructor(e,n,r){this._isDeleted=!1,this._options=Object.assign({},e),this._config=Object.assign({},n),this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=r,this.container.addComponent(new S("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}checkDestroyed(){if(this.isDeleted)throw v.create("app-deleted",{appName:this._name})}}function st(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:he,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw v.create("bad-app-name",{appName:String(s)});if(n||(n=Qe()),!n)throw v.create("no-options");const i=F.get(s);if(i){if(oe(n,i.options)&&oe(r,i.config))return i;throw v.create("duplicate-app",{appName:s})}const a=new Nn(s);for(const l of de.values())a.addComponent(l);const o=new Cr(n,r,a);return F.set(s,o),o}function Sr(t=he){const e=F.get(t);if(!e&&t===he&&Qe())return st();if(!e)throw v.create("no-app",{appName:t});return e}function D(t,e,n){var r;let s=(r=Ir[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),a=e.match(/\s|\//);if(i||a){const o=[`Unable to register library "${s}" with version "${e}":`];i&&o.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&a&&o.push("and"),a&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),T.warn(o.join(" "));return}O(new S(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr="firebase-heartbeat-database",Ar=1,B="firebase-heartbeat-store";let te=null;function it(){return te||(te=q(Tr,Ar,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(B)}catch(n){console.warn(n)}}}}).catch(t=>{throw v.create("idb-open",{originalErrorMessage:t.message})})),te}function Rr(t){return c(this,null,function*(){try{const n=(yield it()).transaction(B),r=yield n.objectStore(B).get(at(t));return yield n.done,r}catch(e){if(e instanceof N)T.warn(e.message);else{const n=v.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});T.warn(n.message)}}})}function xe(t,e){return c(this,null,function*(){try{const r=(yield it()).transaction(B,"readwrite");yield r.objectStore(B).put(e,at(t)),yield r.done}catch(n){if(n instanceof N)T.warn(n.message);else{const r=v.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});T.warn(r.message)}}})}function at(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lr(t){O(new S("platform-logger",e=>new Gn(e),"PRIVATE")),O(new S("heartbeat",e=>new Or(e),"PRIVATE")),D(ue,Ue,t),D(ue,Ue,"esm2017"),D("fire-js","")}Lr("");var Pr="firebase",Br="10.12.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */D(Pr,Br,"app");const ot="@firebase/installations",me="0.6.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt=new Map;function yt(t,e){const n=z(t);_t(n,e),Yr(n,e)}function _t(t,e){const n=wt.get(t);if(n)for(const r of n)r(e)}function Yr(t,e){const n=Xr();n&&n.postMessage({key:t,fid:e}),Qr()}let C=null;function Xr(){return!C&&"BroadcastChannel"in self&&(C=new BroadcastChannel("[Firebase] FID Change"),C.onmessage=t=>{_t(t.data.key,t.data.fid)}),C}function Qr(){wt.size===0&&C&&(C.close(),C=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ct="installations",ws="installations-internal",ys=t=>{const e=t.getProvider("app").getImmediate(),n=bs(e),r=ge(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},_s=t=>{const e=t.getProvider("app").getImmediate(),n=ge(e,Ct).getImmediate();return{getId:()=>ps(n),getToken:s=>gs(n,s)}};function Is(){O(new S(Ct,ys,"PUBLIC")),O(new S(ws,_s,"PRIVATE"))}Is();D(ot,me);D(ot,me,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const li=t=>{const e=new ci(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return self.addEventListener("push",n=>{n.waitUntil(Qs(n,e))}),self.addEventListener("pushsubscriptionchange",n=>{n.waitUntil(Xs(n,e))}),self.addEventListener("notificationclick",n=>{n.waitUntil(Zs(n))}),e};function ui(){O(new S("messaging-sw",li,"PUBLIC"))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ui();pn([{"revision":null,"url":"assets/AppSettings-CgWdgbBa.js"},{"revision":null,"url":"assets/BaseLayout-DaH7SjsC.js"},{"revision":null,"url":"assets/CheckInPanel-DKFfN-fF.js"},{"revision":null,"url":"assets/claims-DVdqQgbb.js"},{"revision":null,"url":"assets/CustomIonModal-D00anYJ2.js"},{"revision":null,"url":"assets/Dashboard-BefPAXBM.js"},{"revision":null,"url":"assets/Dashboard-CPe-9d6m.js"},{"revision":null,"url":"assets/Dashboard-DQw1hWtx.js"},{"revision":null,"url":"assets/Detail-BJd1S9Cj.js"},{"revision":null,"url":"assets/EmployeeAdvanceBalance-C2GsLzVt.js"},{"revision":null,"url":"assets/EmployeeAdvanceIcon-DLcqETOy.js"},{"revision":null,"url":"assets/EmployeeAdvanceItem-DtILXPUZ.js"},{"revision":null,"url":"assets/EmployeeAvatar-C1d6vhGd.js"},{"revision":null,"url":"assets/ExpenseAdvancesTable-BYmbJ_wh.js"},{"revision":null,"url":"assets/ExpenseClaimItem-BGSYhE9n.js"},{"revision":null,"url":"assets/ExpenseClaimSummary-DjSCw6fx.js"},{"revision":null,"url":"assets/ExpenseItems-CHO3hEHZ.js"},{"revision":null,"url":"assets/ExpensesTable-Cer-fMBk.js"},{"revision":null,"url":"assets/ExpenseTaxesTable-CZKU9GYe.js"},{"revision":null,"url":"assets/FileUploaderView-DrqnjYb4.css"},{"revision":null,"url":"assets/FileUploaderView-QDDRfQKT.js"},{"revision":null,"url":"assets/focus-visible-supuXXMI.js"},{"revision":null,"url":"assets/Form-Be2Nbc_q.js"},{"revision":null,"url":"assets/Form-C754gHp0.js"},{"revision":null,"url":"assets/Form-D1MXZzOG.js"},{"revision":null,"url":"assets/FormattedField-DbdTCiwf.js"},{"revision":null,"url":"assets/formatters-BXUkm3h3.js"},{"revision":null,"url":"assets/FormField-C0HuUIcu.js"},{"revision":null,"url":"assets/FormView-CA7DsM24.js"},{"revision":null,"url":"assets/frappe-ui-BRfrkV0W.js"},{"revision":null,"url":"assets/frappe-ui-ClB6VVjP.css"},{"revision":null,"url":"assets/Holidays-DuOkZ37y.js"},{"revision":null,"url":"assets/Home-BUQaqxYc.js"},{"revision":null,"url":"assets/index-BNMDwaus.js"},{"revision":null,"url":"assets/index-CNgOQwA7.css"},{"revision":null,"url":"assets/index9-DGPu_fyN.js"},{"revision":null,"url":"assets/input-shims-CXWtTmXj.js"},{"revision":null,"url":"assets/InvalidEmployee-bE5PcHfr.js"},{"revision":null,"url":"assets/ios.transition-BXGQCyaT.js"},{"revision":null,"url":"assets/LeaveBalance-Bht4QMW9.js"},{"revision":null,"url":"assets/LeaveRequestItem-BrviSeHp.js"},{"revision":null,"url":"assets/leaves-B9zByXSC.js"},{"revision":null,"url":"assets/Link-f5C1dBCm.js"},{"revision":null,"url":"assets/List-BjEPW3nk.js"},{"revision":null,"url":"assets/List-BKh6EACW.js"},{"revision":null,"url":"assets/List-CnETCF3F.js"},{"revision":null,"url":"assets/ListFiltersActionSheet-DtBKPHl3.js"},{"revision":null,"url":"assets/ListView-cB9B05l1.js"},{"revision":null,"url":"assets/Login-D6Rr2VTE.js"},{"revision":null,"url":"assets/md.transition-Cb7yoP95.js"},{"revision":null,"url":"assets/Notifications-C4cRB828.js"},{"revision":null,"url":"assets/notifications-D0XytqHR.js"},{"revision":null,"url":"assets/Profile-BQDsg-Rm.js"},{"revision":null,"url":"assets/ProfileInfoModal-CuuTcaIF.js"},{"revision":null,"url":"assets/QuickLinks-BmQGqFwF.js"},{"revision":null,"url":"assets/realtime-5zeDazFm.js"},{"revision":null,"url":"assets/RequestList-BxQvEZBY.js"},{"revision":null,"url":"assets/RequestList-PHykWsgg.css"},{"revision":null,"url":"assets/RequestPanel-D5waYpAX.js"},{"revision":null,"url":"assets/SalaryDetailTable-B_BfvggU.js"},{"revision":null,"url":"assets/SalarySlipItem-X3vdysRk.js"},{"revision":null,"url":"assets/SemicircleChart-D8Dt8fN4.js"},{"revision":null,"url":"assets/status-tap-BA14rrP_.js"},{"revision":null,"url":"assets/swipe-back-WVWpNaoo.js"},{"revision":null,"url":"assets/TabButtons-BJxEFQt7.js"},{"revision":null,"url":"assets/workflow-CmDWiFMf.js"},{"revision":null,"url":"assets/WorkflowActionSheet-BPfGRu45.js"},{"revision":null,"url":"assets/WorkflowActionSheet-CepcMqYJ.css"},{"revision":"2f97d86dd8bd2c8c822b997a3ac570ad","url":"frappe-push-notification.js"},{"revision":"9e06035bc0f3dc0afc697bac7fa7e30d","url":"index.html"},{"revision":"4fb47154d7fb88487d99b3939097b54a","url":"manifest.webmanifest"}]);dn();const gi=new URL(location).searchParams.get("config");try{let n=function(){return navigator.userAgent.toLowerCase().includes("chrome")};const t=st(JSON.parse(gi)),e=fi(t);pi(e,r=>{const s=r.data.title;let i={body:r.data.body||""};r.data.notification_icon&&(i.icon=r.data.notification_icon),n()?i.data={url:r.data.click_action}:r.data.click_action&&(i.actions=[{action:r.data.click_action,title:"View Details"}]),self.registration.showNotification(s,i)}),n()&&self.addEventListener("notificationclick",r=>{r.stopImmediatePropagation(),r.notification.close(),r.notification.data&&r.notification.data.url&&clients.openWindow(r.notification.data.url)})}catch(t){console.log("Failed to initialize Firebase",t)}self.skipWaiting();gn();console.log("Service Worker Initialized");
